...
@Composable
fun LogsScreen(navController: NavController, isBottomSheetVisibleOverride: MutableState<Boolean>? = null) {
    ...
    Scaffold(
        ...
        floatingActionButton = { AddLogFloatingActionButton(onAddClick = { isBottomSheetVisible.value = true }) }
    ) { paddingValues ->
...
@Composable
fun AddLogFloatingActionButton(onAddClick: () -> Unit) {
